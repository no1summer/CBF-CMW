    ...
    fileDirectory = 'F:\800nm OCT computer data\021622_2_validation\bf 021622-2\';
    fileName1='40x-2';
    fileName2 = '.mov';
    Vol(1:1080,1:1920,1:128) = 0;
    
   
    mkdir(strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\pure_phase\',fileName1));
    mkdir(strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\pure_freq\',fileName1));
    mkdir(strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\complete_freq\',fileName1));
    mkdir(strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\complete_phase\',fileName1));
    mkdir(strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\pure_phase_gray\',fileName1));
    mkdir(strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\hist\',fileName1));
    ...
    imwrite (mat2gray(filteredSpectralImage2D),strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\','bright_field_Amp_T',fileName1,num2str(bas_num),'.tif'));
    ...
    imwrite (outputimg1,strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\pure_freq\',fileName1,'\bright_field_pure_T',num2str(bas_num),'.tif'));
    ...
    imwrite(outputimg2,strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\complete_freq\',fileName1,'\bright_field_complete_T',num2str(bas_num),'.tif'));
    close(hFig);
    %{
    ...
    saveas(f, strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\hist\',fileName1,'\hist_T',num2str(bas_num),'.tif'));
    close(f);
                   ...
                   temp = angle(phasevol(:,:,:));
                   phaseImage2D(:,:)=(temp(:,:,round(5*NFFT/Fs)+1)+3.14).*binaryImage(:,:);
                   
                
        %phaseImage2D(Indice)=0;
        imwrite (ind2rgb(im2uint8(mat2gray(phaseImage2D)),parula),strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\pure_phase\',fileName1,'\bright_field_pure_T',num2str(bas_num),'.tif'));
        hFig=figure;
        imagesc(phaseImage2D);
        colorbar;
        [cdata,colorMap]=getframe(hFig);
        imwrite(cdata,strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\complete_phase\',fileName1,'\bright_field_complete_T',num2str(bas_num),'.tif'));
        close(hFig);
        
        imwrite(mat2gray(phaseImage2D),strcat(fileDirectory,'128f_3std_40x_2\threshold110_5Hz\pure_phase_gray\',fileName1,'\bright_field_pure_T',num2str(bas_num),'.tif'));
    end
