...
%it is not the drifting that matters 
    ...
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15\pure_freq'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15\hist'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15\complete_freq'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15\complete_phase'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15\pure_phase_gray'));
 ...
 for bas_num=startnum:endnum
    ...
    imwrite (outputimg1,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15\pure_freq\',fileName1,'pure_freq',num2str(bas_num),'.tif'));
    ...
    imwrite(outputimg2,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15\complete_freq\','complete',num2str(bas_num),'.tif'));
    close(hFig);
    ...
    saveas(f, strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15\hist\',fileName1,'hist',num2str(bas_num),'.tif'));
    close(f);
    
    
    
    for t=2:size(uniquenumber)
        mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15_',num2str(uniquenumber(t)),'Hz'));
        ...
        imwrite (ind2rgb(im2uint8(mat2gray(phaseImage2D)),parula),strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_2std\threshold40_2to15_',num2str(uniquenumber(t)),'Hz\',fileName1,'pure_phase_at_freq',num2str(uniquenumber(t)),'Hz',num2str(bas_num),'.tif'));
        ...
        colorbar;
        [cdata,colorMap]=getframe(hFig);
        imwrite(cdata,strcat(fileDirectory,'128f_result_2std\threshold40_2to15\complete_phase\',num2str(bas_num),'_',num2str(uniquenumber(t)),'.tif'));
        close(hFig);
        
        imwrite(mat2gray(phaseImage2D),strcat(fileDirectory,'128f_result_2std\threshold40_2to15\pure_phase_gray\',num2str(bas_num),'_',num2str(uniquenumber(t)),'.tif'));
        %}
    end
 end 
