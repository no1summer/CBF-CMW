...
%it is not the drifting that matters 
    ...
    fileDirectory = 'G:\800nm OCT computer data\011422_validation\800nm_011422_oviduct_infun_1000x10000_1x0.1_7us_10ms_4\images\';

    fileName1='800nm_011422_oviduct_infun_1000x10000_1x0.1_7us_10ms_4';
    fileName2 = '.tif';
 ...
 for bas_num=startnum:endnum
    ...
    imwrite (ind2rgb(im2uint8(mat2gray(frequencyImage)),parula),strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\pure_freq\',fileName1,'pure_freq',num2str(bas_num),'.tif'));
    ...
    imwrite(cdata,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\complete_freq\','complete',num2str(bas_num),'.tif'));
    close(hFig);
