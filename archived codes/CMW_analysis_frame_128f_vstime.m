...
%it is not the drifting that matters 
    ...
    fileDirectory = 'G:\800nm OCT computer data\021622_2_validation\800nm_021622_oviduct_infun_1000x10000_1x0.1_7us_10ms_4\';

    fileName1='800nm_021622_oviduct_infun_1000x10000_1x0.1_7us_10ms_4';
    fileName2 = '.tif';
    ...
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\pure_freq'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\hist'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\complete_freq'));
        
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\complete_phase'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\pure_phase_gray'));
 ...
 for bas_num=startnum:endnum
    ...
    rawimage=ind2rgb(im2uint8(mat2gray(frequencyImage)),parula);
    ...
    imwrite(rgbImg,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\pure_freq\',fileName1,'pure_freq',num2str(bas_num),'.tif'));
    ...
    imwrite(rgbImage,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\complete_freq\','complete',num2str(bas_num),'.tif'));
    close(hFig);
    ...
    saveas(f, strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15\hist\',fileName1,'hist',num2str(bas_num),'.tif'));
    close(f);
    
    for freq=5
        mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15_',num2str(freq),'Hz\pure_phase'));
    ...
    %for t=2:size(uniquenumber)
        ...
        imwrite (ind2rgb(im2uint8(mat2gray(phaseImage2D)),parula),strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold40_2to15_',num2str(freq),'Hz\pure_phase\',fileName1,'pure_phase_at_freq',num2str(freq),'Hz',num2str(bas_num),'.tif'));
        ...
        colorbar;
        [cdata,colorMap]=getframe(hFig);
        imwrite(cdata,strcat(fileDirectory,'128f_result_3std\threshold40_2to15\complete_phase\',num2str(bas_num),'_',num2str(uniquenumber(t)),'.tif'));
        close(hFig);
        
        imwrite(mat2gray(phaseImage2D),strcat(fileDirectory,'128f_result_3std\threshold40_2to15\pure_phase_gray\',num2str(bas_num),'_',num2str(uniquenumber(t)),'.tif'));
        %}
    end
 end 
