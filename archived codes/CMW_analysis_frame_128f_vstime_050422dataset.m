...
%it is not the drifting that matters 
    ...
    fileDirectory = 'G:\800nm OCT computer data\050422 validation\800nm_050422_ex_vivo_validation_oviduct_1000x10000_1x0.1_7us_10ms_5\images\';
 ...
 for bas_num=startnum:endnum
    ...
    imwrite (ind2rgb(im2uint8(mat2gray(frequencyImage)),parula),strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold55_2to15\pure_freq\',fileName1,'pure_freq',num2str(bas_num),'.tif'));
    ...
    imwrite(cdata,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_3std\threshold55_2to15\complete_freq\','complete',num2str(bas_num),'.tif'));
    close(hFig);
