    ...
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold80_2to15\pure_freq'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold80_2to15\hist'));
    mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold80_2to15\complete_freq'));
    ...
    imwrite (outputimg1,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold80_2to15\pure_freq\pure_bright_field_pure_T',num2str(bas_num),'.tif'));
    ...
    imwrite(outputimg2,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold80_2to15\complete_freq\bright_field_complete_T',num2str(bas_num),'.tif'));
    close(hFig);
    ...
    saveas(f, strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold80_2to15\hist\hist_T',num2str(bas_num),'.tif'));
    close(f);
    
    
      for thresholding=1.5
       ...
       mkdir(strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold80_2to15\ampmask_phase_',num2str(thresholding),'std_rotate\'));
       temp = angle(phasevol(:,:,:));
        phaseImage2D(:,:)=(temp(:,:,t+1)+3.14).*binaryImage(:,:).*Ampmask(:,:,t+1);
        threshold=binaryImage(:,:).*Ampmask(:,:,t+1);
        %{
       ...
       redChannel3 = uint8(orgimg3(:, :, 1)*256);
        ...
        imwrite (outputimg3,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold70_2to15\ampmask_phase_',num2str(thresholding),'std\Positive_T',num2str(bas_num),'_C',num2str(uniquenumber(t)),'Hz.tif'));
      %}
       ...
       redChannel4 = uint8(orgimg4(:, :, 1)*256);
        ...
        imwrite (imgrotate,strcat(fileDirectory,num2str(startnum),'to',num2str(endnum),'_128f_result_1.5std\threshold80_2to15\ampmask_phase_',num2str(thresholding),'std_rotate\black_T',num2str(bas_num),'_C',num2str(uniquenumber(t)),'Hz.tif'));
       end 
       end 
    %{
    hFig=figure;
